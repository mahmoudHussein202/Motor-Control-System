 ...
 * *********** Macros Values **************
*****************************************/
#define MIN_AVG_TEMPERATURE           10
#define MAX_AVG_TEMPERATURE           25 
#define ECU2_KEEP_ALIVE_ID            0x120
#define ECU2_TEMPERATURE_ID           0x121
#define KNOWN_VOLTAGE_COMP_MIN        20  //mv
#define KNOWN_VOLTAGE_COMP_MAX        100
